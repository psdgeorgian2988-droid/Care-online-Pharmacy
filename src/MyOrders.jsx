...
<div className="order-details-address">
  {isDiagnostics && (
    <>
      <p>
        <strong>
          {selectedOrder.orderType === "lab" ? "Lab Partner" : "Imaging Partner"}:
        </strong>{" "}
        {selectedOrder.partner || "Not provided"}
      </p>
      <p>
        <strong>Patient:</strong> {selectedOrder.patientName || "Not provided"}
      </p>
      <p>
        <strong>Mobile:</strong> {selectedOrder.mobile || "Not provided"}
      </p>
      <p>
        <strong>
          {selectedOrder.orderType === "lab" ? "Collection Type" : "Appointment Type"}:
        </strong>{" "}
        {selectedOrder.visitType === "home" ? "Home Collection" : "Centre Visit"}
      </p>
      <p>
        <strong>Appointment Date:</strong> {selectedOrder.appointmentDate || "Not provided"}
      </p>
      <p>
